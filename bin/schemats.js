...
(() => __awaiter(this, void 0, void 0, function* () {
    try {
        ...
        let formattedOutput = yield index_1.typescriptOfSchema(db, argv.n, argv.t, argv.s, index_1.extractCommand(process.argv, argv.c), index_1.getTime());
        yield fsAsync.writeFileAsync(argv.o, formattedOutput);
    }
    catch (e) {
        console.error(e);
        process.exit(1);
